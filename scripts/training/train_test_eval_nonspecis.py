...
BATCH_SIZE = 32
EPOCHS = 20
DATA_DIR = './training/species/17'
MODEL_SAVE_PATH = './models/tree_frog_classifier.keras'
BEST_MODEL_PATH = './models/best_tree_frog_classifier.keras'
...
model = models.Sequential([
    ...
    layers.MaxPooling2D(),
    layers.Dropout(0.25),  # new dropout here
...
# Recreate loader with batch_size=1 for test
...
# === Copy misclassified to export folder ===
